...
export default function App() {
  ...
  // Site status check - with safe defaults if it fails
  ...
  // Only enforce if siteStatus is loaded and site is explicitly disabled
  if (siteStatus && siteStatus.is_active === false) {
    return (
      <BrowserRouter>
        <Routes>
